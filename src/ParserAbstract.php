...
use Naka507\PhpParser\Node\Scalar\LNumber;
use Naka507\PhpParser\Node\Scalar\String_;
use Naka507\PhpParser\Node\Stmt\Class_;
use Naka507\PhpParser\Node\Stmt\ClassConst;
use Naka507\PhpParser\Node\Stmt\ClassMethod;
use Naka507\PhpParser\Node\Stmt\Interface_;
use Naka507\PhpParser\Node\Stmt\Namespace_;
use Naka507\PhpParser\Node\Stmt\Property;
use Naka507\PhpParser\Node\Stmt\TryCatch;
use Naka507\PhpParser\Node\Stmt\UseUse;
