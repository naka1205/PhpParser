...
use Naka507\PhpParser\NodeVisitor\FindingVisitor;
use Naka507\PhpParser\NodeVisitor\FirstFindingVisitor;
...
class NodeFinder
{
     ...
     */
    public function findInstanceOf($nodes, string $class) {
